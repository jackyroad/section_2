...
static void Rheostat_ADC_Mode_Config(void)
{
  ...
  ADC_RegularChannelConfig(RHEOSTAT_ADC1, RHEOSTAT_ADC1_CHANNEL1, 1, ADC_SampleTime_56Cycles);
  ADC_RegularChannelConfig(RHEOSTAT_ADC2, RHEOSTAT_ADC2_CHANNEL1, 1, ADC_SampleTime_56Cycles);
