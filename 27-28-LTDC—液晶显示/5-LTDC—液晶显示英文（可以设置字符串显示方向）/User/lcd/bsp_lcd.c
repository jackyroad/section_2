...
void LCD_DrawSome(uint16_t Xpos, uint16_t Ypos, uint8_t Mode,uint32_t Color)
{
	...
	{
		case 0: 
			     videoMemory = CurrentFrameBuffer + ((Xpos + (Ypos*LCD_PIXEL_WIDTH))*3);
				 *(__IO uint16_t*)(videoMemory) = Color;		
		break;
		case 1:
				 videoMemory = CurrentFrameBuffer + (((LCD_PIXEL_WIDTH - Ypos - 1) + (Xpos*LCD_PIXEL_WIDTH))*3);
				 *(__IO uint16_t*)(videoMemory) = Color;
		break;		
		case 2:
				 videoMemory = CurrentFrameBuffer + ((LCD_PIXEL_HEIGHT*LCD_PIXEL_WIDTH - (Xpos + (Ypos* LCD_PIXEL_WIDTH) + 1))*3);
				 *(__IO uint16_t*)(videoMemory) = Color;
		break;		
		case 3:
				 videoMemory = CurrentFrameBuffer + ((LCD_PIXEL_HEIGHT*LCD_PIXEL_WIDTH - ((LCD_PIXEL_WIDTH - Ypos) + Xpos*LCD_PIXEL_WIDTH))*3);
				 *(__IO uint16_t*)(videoMemory) = Color;
		break;		
	}		
}
...
void LCD_LayerInit(void)
{
 ...
 LTDC_Layer_InitStruct.LTDC_ConstantAlpha = 1;
...
void LCD_DrawSome(uint16_t Xpos, uint16_t Ypos, uint8_t Mode,uint32_t Color)
{
	...
	{
		case 0: 
			     videoMemory = CurrentFrameBuffer + ((Xpos + (Ypos*LCD_PIXEL_WIDTH))*2);
				 *(__IO uint16_t*)(videoMemory) = Color;		
		break;
		case 1:
				 videoMemory = CurrentFrameBuffer + (((LCD_PIXEL_WIDTH - Ypos - 1) + (Xpos*LCD_PIXEL_WIDTH))*2);
				 *(__IO uint16_t*)(videoMemory) = Color;
		break;		
		case 2:
		...
		break;		
		case 3:
				 videoMemory = CurrentFrameBuffer + ((LCD_PIXEL_HEIGHT*LCD_PIXEL_WIDTH - ((LCD_PIXEL_WIDTH - Ypos) + Xpos*LCD_PIXEL_WIDTH))*2);
				 *(__IO uint16_t*)(videoMemory) = Color;
		break;		
	}		
}
